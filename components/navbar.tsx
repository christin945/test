...
export function Navbar() {
  ...
  return (
    ...
    <header className="navbar-container sticky top-0 z-50 shadow-sm">

      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">

        {/* LOGO */}
        <Link href={dashboardLink} className="flex items-center gap-2 group">
          <div className="logo-box flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-r from-blue-500 to-blue-600">
            ...
            <div className="flex flex-col gap-3">
              ...
              {userData?.role === "teacher" ? (
                ...
                <>
                  ...
                  <Link href="/student/settings" onClick={() => setMobileOpen(false)}>
                    <Button className="w-full flex items-center gap-2 bg-blue-500 hover:bg-blue-600">
                      <User className="h-4 w-4" />
                      Settings
                    </Button>
              ...
              <Button
                ...
                className="w-full flex items-center gap-2 bg-red-500 hover:bg-red-600 mt-2"
              >
